...
function calculate_AP(){
      var AP = Math.ceil(
                  (1  * document.getElementById("sim_screen").value)(2  * document.getElementById("mid_screen").value)(3  * document.getElementById("diff_screen").value) (2  * document.getElementById("sim_report").value) (5  * document.getElementById("mid_report").value)(8  * document.getElementById("diff_report").value) (10 * document.getElementById("components").value)
              );
